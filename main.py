...
group_parser.add_argument('--GEN_LEARNING_RATE', type = float, default = 1e-4, help = 'Learning Rate of Generator')
group_parser.add_argument('--DIS_LEARNING_RATE', type = float, default = 1e-4, help = 'Learning Rate of Discriminator')
group_parser.add_argument('--N_UPDATE_DIS', type = int, default = 5, help = 'Number of Updates of Dis per one for GEN and CLS')
